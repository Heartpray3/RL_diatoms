...
while found_functions is False:
  try:
    ...
    print('Hello multi bodies')
    from mobility import mobility as mb
    from quaternion_integrator.quaternion import Quaternion
    from quaternion_integrator.quaternion_integrator_multi_bodies_bacillaria import QuaternionIntegrator
...
if __name__ == '__main__':
  ...
  # Parameters to plot velocity field
